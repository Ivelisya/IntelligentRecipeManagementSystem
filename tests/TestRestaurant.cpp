...
int main() {
    ...
    try {
        RecipeApp::Restaurant r1 =
            RecipeApp::Restaurant::builder(1, "Test Cafe")
    ...
    try {
        RecipeApp::Restaurant r2 = RecipeApp::Restaurant::builder(2, "Old Name")
    ...
    try {
        RecipeApp::Restaurant r3 =
            RecipeApp::Restaurant::builder(3, "Recipe Hub")
    ...
    try {
        RecipeApp::Restaurant r4 =
            RecipeApp::Restaurant::builder(4, "Food Spot")
